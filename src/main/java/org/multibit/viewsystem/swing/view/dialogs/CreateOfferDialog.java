 ...
 */
public class CreateOfferDialog extends MultiBitDialog {
    ...
    private CreateNewOfferPanel createOfferPanel; 

    /**
     * Creates a new {@link CreateOfferDialog}.
     */
    public CreateOfferDialog(BitcoinController bitcoinController, MultiBitFrame mainFrame, TradeingPanel tradePanel) {
        super(mainFrame, bitcoinController.getLocaliser().getString("createNewOfferDialog.title"));
        ...
        createOfferPanel.getCancelButton().requestFocusInWindow();
    ...
    public void initUI() {
        ...
        createOfferPanel = new CreateNewOfferPanel(this.bitcoinController, tradePanel, this);
        
        setLayout(new BorderLayout());
        add(createOfferPanel, BorderLayout.CENTER);
    }

    public CreateNewOfferPanel getNewOffersPanel() {
        return createOfferPanel;
    }
    /*
