...
public class TradingPanel extends JPanel implements Viewable {
    ...
    public TradingPanel(BitcoinController bitcoinController, MultiBitFrame mainFrame) {
    ...
    private void initUI() {
        ...
        JPanel transactionsPanel = createTradingPanel();
...
/*
    ...
    public void updatedExchangeRate(ExchangeRate exchangeRate) {
        TradingPanel.updateTransactions();
    }
    */
}