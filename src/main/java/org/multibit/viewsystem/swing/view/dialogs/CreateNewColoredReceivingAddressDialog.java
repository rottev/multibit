 ...
 */
public class CreateNewColoredReceivingAddressDialog extends MultiBitDialog {
    ...
    /**
     * Creates a new {@link CreateNewColoredReceivingAddressDialog}.
     */
    public CreateNewColoredReceivingAddressDialog(BitcoinController bitcoinController, MultiBitFrame mainFrame, TradeingPanel tradeBitcoinPanel) {
        ...
        createNewColoredReceivingAddressPanel.getCancelButton().requestFocusInWindow();
    ...
    public void initUI() {
        ...
        createNewColoredReceivingAddressPanel = new CreateNewColoredReceivingAddressPanel(this.bitcoinController, tradeBitcoinPanel, this);
        
        setLayout(new BorderLayout());
        add(createNewColoredReceivingAddressPanel, BorderLayout.CENTER);
    }

    public TradeingPanel getReceiveBitcoinPanel() {
        return tradeBitcoinPanel;
    }
    
    public int getNumberOfAddressesToCreate() {
        return createNewColoredReceivingAddressPanel.getNumberOfAddressesToCreate();
    }

    public JComboBox getNumberOfAddresses() {
        return createNewColoredReceivingAddressPanel.getNumberOfAddresses();
    }
}