 ...
 * address dialog.
 */
public class CreateAssetAction extends MultiBitSubmitAction {
    private static Logger log = LoggerFactory.getLogger(CreateAssetAction.class);
    ...
    /**
     * Creates a new {@link CreateAssetAction}.
     */
    public CreateAssetAction(BitcoinController bitcoinController, MultiBitFrame mainFrame,
            TradeingPanel tradeBitcoinPanel) {
        super(bitcoinController, "createNewAssetAction.createReceiving.text", "createNewAssetAction.createReceiving.tooltip",
                "createNewAssetAction.createReceiving.mnemonicKey", null);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
        	CreateAssetDialog createAssetDialog = new CreateAssetDialog(super.bitcoinController,
                    mainFrame, tradeBitcoinPanel);
        	createAssetDialog.setVisible(true);
        } finally {
            setEnabled(true);
