 ...
 * address dialog.
 */
public class IssueAssetAction extends MultiBitSubmitAction {
    private static Logger log = LoggerFactory.getLogger(IssueAssetAction.class);
    ...
    /**
     * Creates a new {@link IssueAssetAction}.
     */
    public IssueAssetAction(BitcoinController bitcoinController, MultiBitFrame mainFrame,
            TradeingPanel tradeBitcoinPanel) {
        super(bitcoinController, "IssueAssetAction.text", "IssueAssetAction.tooltip",
                "IssueAssetAction.mnemonicKey", null);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
        	IssueAssetDialog issueAssetDialog = new IssueAssetDialog(super.bitcoinController,
