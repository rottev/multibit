 ...
 * address dialog.
 */
public class CreateNewColoredReceivingAddressAction extends MultiBitSubmitAction {
    private static Logger log = LoggerFactory.getLogger(CreateNewColoredReceivingAddressAction.class);
    ...
    /**
     * Creates a new {@link CreateNewColoredReceivingAddressAction}.
     */
    public CreateNewColoredReceivingAddressAction(BitcoinController bitcoinController, MultiBitFrame mainFrame,
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            CreateNewColoredReceivingAddressDialog createNewColoredReceivingAddressDialog = new CreateNewColoredReceivingAddressDialog(super.bitcoinController,
                    mainFrame, tradeBitcoinPanel);
            createNewColoredReceivingAddressDialog.setVisible(true);
        } finally {
            setEnabled(true);
