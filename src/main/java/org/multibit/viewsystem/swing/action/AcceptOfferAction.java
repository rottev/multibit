 ...
 * address dialog.
 */
public class AcceptOfferAction extends MultiBitSubmitAction {
    private static Logger log = LoggerFactory.getLogger(AcceptOfferAction.class);
    ...
    /**
     * Creates a new {@link AcceptOfferAction}.
     */
    public AcceptOfferAction(BitcoinController bitcoinController, MultiBitFrame mainFrame,
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
        	AcceptOfferDialog acceptfferDialog = new AcceptOfferDialog(super.bitcoinController,
                    mainFrame, tradeBitcoinPanel);
        	acceptfferDialog.setVisible(true);
        } finally {
            setEnabled(true);
