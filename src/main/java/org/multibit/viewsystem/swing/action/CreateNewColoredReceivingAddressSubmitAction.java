...
import org.multibit.viewsystem.swing.view.panels.CreateNewColoredReceivingAddressPanel;
 ...
 * addresses.
 */
public class CreateNewColoredReceivingAddressSubmitAction extends MultiBitSubmitAction implements WalletBusyListener {
    private static Logger log = LoggerFactory.getLogger(CreateNewColoredReceivingAddressSubmitAction.class);
    ...
    private CreateNewColoredReceivingAddressPanel createNewColoredReceivingAddressPanel;
    ...
    /**
     * Creates a new {@link CreateNewColoredReceivingAddressSubmitAction}.
     */
    public CreateNewColoredReceivingAddressSubmitAction(BitcoinController bitcoinController,
            CreateNewColoredReceivingAddressDialog createNewColoredReceivingAddressDialog,
            CreateNewColoredReceivingAddressPanel createNewColoredReceivingAddressPanel, JPasswordField walletPassword, String name) {
        ...
        this.createNewColoredReceivingAddressPanel = createNewColoredReceivingAddressPanel;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (super.bitcoinController.getModel().getActiveWallet() != null
            ...
            if (walletPassword.getPassword() == null || walletPassword.getPassword().length == 0) {
                ...
                createNewColoredReceivingAddressPanel.setMessageText(controller.getLocaliser().getString(
        ...
        if (!perWalletModelData.isBusy()) {
            ...
            createNewColoredReceivingAddressPanel.getCancelButton().setEnabled(false);

            int numberOfAddressesToCreate = createNewColoredReceivingAddressPanel.getNumberOfAddressesToCreate();
            ...
            createNewColoredReceivingAddressPanel.setMessageText(shortMessage);
            ...
            createNewReceivingAddressesInBackground(numberOfAddressesToCreate, encryptNewKeys, 
    ...
    private void createNewReceivingAddressesInBackground(final int numberOfAddressesToCreate, final boolean encryptNewKeys, 
            final CharSequence walletPassword, final CreateNewColoredReceivingAddressSubmitAction thisAction) {
                ...
                final KeyCrypter walletKeyCrypter = finalPerWalletModelData.getWallet().getKeyCrypter();
                    try {
                        ...
                        for (ECKey newKey : newKeys) {
                            ...
                            finalPerWalletModelData.getWalletInfo().addReceivingAddress(new WalletAddressBookData(adressName, lastAddressString),
                                false);
                        }
            ...
            protected void done() {
                try {
                    ...
                    if (wasSuccessful) {
                        ...
                        if (createNewColoredReceivingAddressPanel.getTradeBitcoinPanel() != null) {
                         //   createNewColoredReceivingAddressPanel.getTradeBitcoinPanel().getAddressesTableModel().fireTableDataChanged();
                         //   createNewColoredReceivingAddressPanel.getTradeBitcoinPanel().selectRows();
                        }
                    ...
                    if (shortMessage != null) {
                        createNewColoredReceivingAddressPanel.setMessageText(shortMessage);           
                         if (createNewColoredReceivingAddressDialog != null && createNewColoredReceivingAddressDialog.isVisible()) {
                    ...
                    createNewColoredReceivingAddressPanel.getCancelButton().setEnabled(true);
